...
```html
<p lang="zh-Hans">
  <strong lang="zh-Hans-CN">菠萝</strong>和<strong lang="zh-Hant-TW">鳳梨</strong
  >其实是同一种水果。只是大陆和台湾称谓不同，且新加坡、马来西亚一带的称谓也是不同的，称之为<strong lang="zh-Hans-SG">黄梨</strong>。
</p>
```
...
比较详细的 favicon 介绍可参考[这里](https://github.com/audreyr/favicon-cheat-sheet)
